  ...
  <div id="footer">
    <div class="container">
      ...
      <div class="row margin-top-60 margin-bottom-40 size-13">
        ...
        <div class="col-md-4">
          <div class="row">
            <div class="col-md-6 text-center"><img style="background: white; width: 100%; height: 100%; border-radius: 10px; padding: 8px;" src="../assets/images/enamad.png" /></div>
            <div class="col-md-6 text-center"><img style="background: white; width: 100%; height: 100%; border-radius: 10px; padding: 15px 8px;" src="../assets/images/samandehi.png" /></div>
          </div>
