            ...
            <div class="col-md-6 col-md-offset-3">
              ...
              <div class="toggle toggle-transparent toggle-accordion toggle-noicon">
                ...
                <div class="toggle active">
                  <label class="size-20"><i class="fa fa-leaf"></i> &nbsp; I'm a returning customer</label>
                    ...
                    <div class="sky-form">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                          ...
                          <button class="btn btn-primary" v-on:click="login"><i class="fa fa-check"></i> LOGIN</button>
                ...
                <div class="toggle">
                  <label class="size-20"><i class="glyphicon glyphicon-user"></i> &nbsp; Don't have an account yet?</label>
                  <div class="toggle-content">
                    ...
                    <form class="nomargin sky-form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6">
                              ...
                              <label class="input margin-bottom-10">
                                <i class="ico-append fa fa-lock"></i>
                                <input required="" type="password" class="err"  v-model="pass">
                            ...
                            <div class="col-md-6 col-sm-6">
                              ...
                              <label class="input margin-bottom-10">
                                <i class="ico-append fa fa-lock"></i>
                                <input required="" type="password" class="err" v-model="newPass">
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <button type="submit" class="btn btn-primary"><i class="fa fa-check" v-on:click="sgnUp"></i> REGISTER</button>
                        </div>
                      </div>
